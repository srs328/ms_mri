...
work_dir_names = ["choroid_pineal2_pituitary_T1-1", "choroid_pineal2_pituitary_T1-2", "choroid_pineal2_pituitary_T1-3", "choroid_pineal2_pituitary_T1-4"]
work_dirs = [training_work_dirs / name / "ensemble_output" for name in work_dir_names]
ensemble_datasets = [fm.scan_3Tpioneer_bids(work_dir, label="t1_ensemble.nii.gz") for work_dir in work_dirs]
...
orig_dataset_proc.prepare_labels(["choroid_t1_flair", "pineal", "pituitary"], ["SRS_T1", "CH", "SRS", "DT", "ED"])
