...
work_dir_names = ["choroid_pineal_pituitary_FLAIR-1", "choroid_pineal_pituitary_FLAIR-2", "choroid_pineal_pituitary_FLAIR-3", "choroid_pineal_pituitary_FLAIR-4"]
work_dirs = [training_work_dirs / name / "ensemble_output" for name in work_dir_names]
ensemble_datasets = [fm.scan_3Tpioneer_bids(work_dir, label="flair_ensemble.nii.gz") for work_dir in work_dirs]
