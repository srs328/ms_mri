...
analysis_dir = msmri_home / "monai_analysis" / "choroid_pineal_pituitary_FLAIR-1"  #* Edit this
inf_label = "flair_choroid_pineal_pituitary_FLAIR-1_pred"
...
df.to_csv(analysis_dir / "clinical_data_full.csv")
